...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dimensionUnit: Schema.Attribute.Enumeration<['mm', 'cm', 'in']> &
      Schema.Attribute.DefaultTo<'cm'>;
    height: Schema.Attribute.Decimal;
    images: Schema.Attribute.Media<'images', true>;
    inventory: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    inventoryPolicy: Schema.Attribute.Enumeration<['deny', 'continue']> &
      Schema.Attribute.DefaultTo<'deny'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    requiresShipping: Schema.Attribute.Boolean &
    ...
    weightUnit: Schema.Attribute.Enumeration<['g', 'kg', 'lb']> &
